...
//int hmin = 24, hmax = 101, smin = 40, smax = 255, vmin = 55, vmax = 255;//LAB2 민트색 물체 값
...
void processVideo(const string& videoPath, int idx)
{
	...
	string filename = "DLIP_LAB2_22000573_JunJaeLee_output_[SAMPLE" + to_string(idx) + "].avi";  // 저장파일 이름
...
int main()
{
	hmin = 13, hmax = 60, smin = 70, smax = 200, vmin = 90, vmax = 200;//SAMPLE 1값
	processVideo("LAB_MagicCloak_Sample1.mp4", 1);
	//processVideo("DLIP_LAB2_22000573_JunJaeLee.mp4");
	hmin = 110, hmax = 176, smin = 87, smax = 255, vmin = 70, vmax = 255;//LAB2 분홍색 물체 값
